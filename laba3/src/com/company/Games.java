...
public class Games implements GetSet {
    ...
    Games(ArrayList<Integer> paragraphСount, String name, int intrParphCount) {
    ...
    public void setParagraphСount (ArrayList<Integer> paragraphСount) {
        if (paragraphСount == null) {
            throw new ParagraphCountIsNullRuntimeException("Game paragraphCount is null");
