...
public class Main {
    ...
    private static void task1() throws InterruptedException { //Создание, запись и чтение массива без синхронизации
        var arr = new GetSetS();
    ...
    private static void task2() { //Создание, запись и чтение массива с синхронизацией
        var arr = new GetSetS();
