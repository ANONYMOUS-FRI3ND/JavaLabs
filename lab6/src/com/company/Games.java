...
public class Games implements GetSet, Serializable {
    ...
    Games(int paragraphСount, String name, int intrParphCount, List<String> author) {
    ...
    public boolean equals(Object obj) {
        return Objects.nonNull(obj) && obj instanceof Games && obj.hashCode() == hashCode();
    }
    ...
    private class Itr implements Iterator<String> {
        ...
        public boolean hasNext() {
            return cursor != Games.this.author.size();
        }

        @Override
        public String next() {
            int i = cursor;
            if (i >= Games.this.author.size()) {
                throw new NoSuchElementException();
            }
            cursor = i + 1;
            return Games.this.author.get(lastRet = i);
        }
        ...
        public void remove() {
            ...
            Games.this.author.remove(lastRet);
            cursor = lastRet;
            lastRet = -1;
        }
    }
