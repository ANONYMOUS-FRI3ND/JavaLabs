...
public class Films implements GetSet, Serializable {
    ...
    Films(int paragraphСount, String name, int intrParphCount, List<String> author) {
    ...
    public boolean equals(Object obj) {
        return Objects.nonNull(obj) && obj instanceof Films && obj.hashCode() == hashCode();
    }
    ...
    private class Itr implements Iterator<String> {
        ...
        public boolean hasNext() {
            return cursor != Films.this.author.size();
        }

        @Override
        public String next() {
            int i = cursor;
            if (i >= Films.this.author.size()) {
                throw new NoSuchElementException();
            }
            cursor = i + 1;
            return Films.this.author.get(lastRet = i);
        }
        ...
        public void remove() {
            ...
            Films.this.author.remove(lastRet);
            cursor = lastRet;
            lastRet = -1;
        }
    }
